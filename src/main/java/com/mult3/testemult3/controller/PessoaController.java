...
import com.mult3.testemult3.repository.PessoaRepository;
...
public class PessoaController {
	...
	@PostMapping
	public ResponseEntity<Pessoa>post(@RequestBody Pessoa nome){
		return ResponseEntity.status(HttpStatus.CREATED).body(repository.save(nome));
	}
	
	@PutMapping
	public ResponseEntity<Pessoa>put(@RequestBody Pessoa nome){
